...
but this particular form is proving somewhat intractable (or I have made mistakes).  A lazier way is to invoke Mathematica, which gives
%\href{https://integrals.wolfram.com/index.jsp}{webmathematica}, which gives
...
\href{https://en.wikipedia.org/wiki/Uncertainty_principle#Matrix_mechanics}{wikipedia uncertainly article}
